...
import "plugin" "tfplan/v2" {
  config = {
    "plan_path": "/Users/ganeshseetharaman/Desktop/dev/cis-sentinel-policies-exploration-poc/fsbp/elb-ensure-multi-az-configuration-classic-load-balancer/plan.json"
  }
}
