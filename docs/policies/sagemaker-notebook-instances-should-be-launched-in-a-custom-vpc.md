...
This rule is covered by the [sagemaker-notebook-instances-should-be-launched-in-a-custom-vpc](../../policies/sagemaker/sagemaker-notebook-instances-should-be-launched-in-a-custom-vpc.sentinel) policy.
