...
This rule is covered by the [rds-for-sql-server-db-instances-should-be-encrypted-in-transit](../../policies/rds/rds-for-sql-server-db-instances-should-be-encrypted-in-transit.sentinel).
