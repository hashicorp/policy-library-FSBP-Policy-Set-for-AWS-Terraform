...
This rule is covered by the [sagemaker-notebook-instances-should-run-on-supported-platforms](../../policies/sagemaker/sagemaker-notebook-instances-should-run-on-supported-platforms.sentinel) policy.
