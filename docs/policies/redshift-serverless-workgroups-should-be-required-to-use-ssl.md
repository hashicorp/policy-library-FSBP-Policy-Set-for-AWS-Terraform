...
This rule is covered by the [redshift-serverless-workgroups-should-be-required-to-use-ssl.sentinel](../../policies/redshiftserverless/redshift-serverless-workgroups-should-be-required-to-use-ssl.sentinel) policy.
