...
This rule is covered by the [rds-for-mariadb-db-instances-should-be-encrypted-in-transit](../../policies/rds/rds-for-mariadb-db-instances-should-be-encrypted-in-transit.sentinel).
