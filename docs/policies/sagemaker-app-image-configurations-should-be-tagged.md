...
This rule is covered by the [sagemaker-app-image-configurations-should-be-tagged](../../policies/sagemaker/sagemaker-app-image-configurations-should-be-tagged.sentinel) policy.
