...
This rule is covered by the [autoscaling-group-should-use-launch-templates](../../policies/autoscaling/autoscaling-group-should-use-launch-templates.sentinel) policy.
