...
This rule is covered by the [rds-for-sql-server-db-instances-should-publish-logs-to-cloudwatch-logs](../../policies/rds/rds-for-sql-server-db-instances-should-publish-logs-to-cloudwatch-logs.sentinel).
