...
This rule is covered by the [route-53-public-hosted-zones-should-log-dns-queries](../../policies/route53/route-53-public-hosted-zones-should-log-dns-queries.sentinel) policy.
