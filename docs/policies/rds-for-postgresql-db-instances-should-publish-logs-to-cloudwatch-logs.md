...
This rule is covered by the [rds-for-postgresql-db-instances-should-publish-logs-to-cloudwatch-logs](../../policies/rds/rds-for-postgresql-db-instances-should-publish-logs-to-cloudwatch-logs.sentinel) policy.
